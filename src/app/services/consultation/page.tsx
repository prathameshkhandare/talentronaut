...
const TESTIMONIALS = [
  { quote: "Their strategic insight saved us six months of development time. They convinced us to pivot our architecture before we hit a dead end.", author: "Elena Rostova", role: "CEO", company: "Nebula AI" },
  { quote: "Talentronaut doesn't just nod and agree. They push back with data. That kind of intellectual honesty is rare and incredibly valuable.", author: "James Thorne", role: "Founder", company: "CivicTech Solutions" },
];
