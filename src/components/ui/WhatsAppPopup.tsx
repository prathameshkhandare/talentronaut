            ...
            <div className="bg-[#fafafa] rounded-2xl shadow-xl p-8 md:p-10 relative">
              ...
              <div className="flex items-center gap-3">
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="flex items-center gap-2 px-5 py-2.5 bg-[#D44531] text-white text-[13px] font-semibold rounded-full hover:bg-[#C13D2B] transition-all"
                >
                ...
                <motion.button
                  ...
                  whileHover={{ scale: 1.02, y: -2 }}
                  whileTap={{ scale: 0.98 }}
                  className="flex items-center gap-2 px-5 py-2.5 bg-white border border-gray-300 text-[#4A4A46] text-[13px] font-medium rounded-full hover:bg-gray-50 transition-all"
                >
